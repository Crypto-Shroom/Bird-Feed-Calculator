...
- [x] Research fresh, plain strawberry across pigeon, parrot, African Grey, budgie, canary, and chicken using independent first-pass and targeted follow-up searches; record only canonical provenance evidence, limitations, and honest unresolved outcomes without active-data, formula, runtime, safety-rule, or public-copy changes.
- [x] Research fresh, plain raspberry across pigeon, parrot, African Grey, budgie, canary, and chicken using independent first-pass and targeted follow-up searches; record only canonical provenance evidence, limitations, and honest unresolved outcomes without active-data, formula, runtime, safety-rule, or public-copy changes.
