...
This README is preserved from the prior fragmented GitHub `main` layout. It describes a partial Python/Codex-era calculator tree and references paths that are now historical. It is **not** the definition of V1, V2, or active V3.

| Preserved item | Meaning in this archive |
|---|---|
| `archive-root/` | Loose files moved during prior root-tidy work. |
| `pigeon-mix-web/` | Legacy pigeon-only placeholder documentation. |
