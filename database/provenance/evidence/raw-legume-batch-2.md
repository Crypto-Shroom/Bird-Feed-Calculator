...
For **pigeons**, neither the direct VCA pigeon/dove guidance nor Palomacy’s pigeon-feeding guidance identifies any of these exact raw dried bean forms. Each first pass and targeted second search was documented. The available exact-form results were inaccessible social posts, generic keeper claims, or evidence for another species; none is elevated into a pigeon outcome. All five pigeon rows therefore remain **unresolved** rather than being inferred from a parrot or chicken source.
...
The **chicken** rows reflect direct poultry evidence rather than companion-bird extrapolation. Raw lima-bean broiler-starter diets hindered growth and were associated with serious histopathological changes, while the soaked/boiled comparator was excepted, supporting `requires_preparation`.[6] Raw pinto-bean studies likewise report poorer growth or performance for raw/non-heated diets and better outcomes with processing.[7] [8] Raw navy-bean meal depressed body weight and produced pancreatic changes in chicks, supporting `requires_preparation`.[9]

Raw fava/broad beans are intentionally recorded as `limited`, rather than universally approved or categorically excluded. The cited direct broiler studies demonstrate outcome sensitivity to formulation, inclusion level, and processing: lower defined dietary inclusion was reported in one study, while a raw-versus-autoclaved comparison reports poorer outcomes under higher raw inclusion. This supports only the controlled poultry-ration context and does not establish a home-feeding rule or complete ration.[10] [11]
...
| `sources.json` | Added the direct chicken study records and companion-bird black-bean preparation source; clarified the existing For the Birds source’s named-bean scope. |
...
[6] [Ologhobo et al. (1993), *Toxicity of Raw Limabeans (Phaseolus lunatus L.) and Limabean Fractions for Growing Chicks*](https://doi.org/10.1080/00071669308417606)

[7] [Arija et al. (2006), *Nutritional Evaluation of Raw and Extruded Kidney Bean (Phaseolus vulgaris L. var. Pinto) in Chicken Diets*](https://doi.org/10.1093/ps/85.4.635)

[8] [Bhave (1964), *A Comparison of Feeding Heated and Non Heated Pinto Bean Meal to Broiler-Strain Chicks*](https://krex.k-state.edu/bitstreams/4e22ae54-f61a-4d26-b382-86c899692ca7/download)

[9] [Hewitt et al. (1973), *A Comparison of Fractions Prepared from Navy (Haricot) Beans (Phaseolus vulgaris L.) in Diets for Germ-free and Conventional Chicks*](https://doi.org/10.1079/BJN19730118)

[10] [Mateos and Puchal (1981), *Raw Broad Beans (Vicia faba L.) as an Energy and Protein Source for Broiler Chicks*](https://doi.org/10.3382/ps.0602486)

[11] [Rubio, Brenes, and Castaño (1990), *The Utilization of Raw and Autoclaved Faba Beans (Vicia faba L., var. minor) and Faba Bean Fractions in Diets for Growing Broiler Chickens*](https://doi.org/10.1079/BJN19900130)
