...
Comprehensive guides and quick-start notes now live in the repository's shared documentation:
- Detailed CLI guides: `docs/python-cli/`
- General user guides and setup notes: `docs/guides/`
- Research references and nutrition notes: `docs/research/`
...
> Run these commands from `python-package/pigeon_mix_calculator/` so local imports like `expanded_ingredients.py` resolve correctly. For expanded ingredient coverage and built-in herb/supplement recommendations, use `pigeon_mix_calculator_v2.py` (same interface and CLI prompts).
...
- Quick reference: `../../docs/python-cli/CLI_QUICK_START.md`
- Full usage guide: `../../docs/python-cli/CLI_USER_GUIDE.md`
- Research references: `../../docs/research/RESEARCH_REFERENCES.md`

## License

This package follows the repository's Non-Commercial Private Use License (NC-PUL-1.0). See `../../LICENSE` for the full terms and commercial licensing requests.
